...
export const CompanyFormComponent: React.FC<ICompanyFormProps> = ({
    ...
    const {
        ...
        initialValues: {
            ...
            company_adress: company ? company.company_adress : "",
            phone_number: company ? company.societe_admin?.phone_number : "",
            fix_number: company ? company.fix_number : "",
            username: company ? company.societe_admin?.username : "",
            first_name: company ? company.societe_admin?.first_name : "",
            email: company ? company.societe_admin?.email : "",
            company_phone_number: company ? company.company_phone_number : "",
            adress: company ? company.societe_admin?.adress : "",
            password: "",
            societe: "default_value",
            company_logo: company ? company.company_logo : "",
            company_stamp: company ? company.company_stamp : "",
        },
        onSubmit,
        validationSchema,
    });
