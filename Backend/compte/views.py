...
class CreateDocumentsStagiaire(generics.GenericAPIView):
	...
	def post(self,request): 
		...
		my_canvas.setFillColor(HexColor(0xff0800))
		my_canvas.drawString(15,730, "Le bénéficiaire s’engage à assurer sa présence aux dates prévues avec son formateur.")
        
		my_canvas.setFillColor(HexColor(0xff0800))
		my_canvas.drawString(15,700, "4. Prix de la formation")
		my_canvas.setFillColor(HexColor(0xff0800))
		my_canvas.drawString(15,680, "En contrepartie de cette action de formation, Nom du financeur s 'acquittera des coûts suivants qui couvrent")
		my_canvas.drawString(15,660, "l'intégralité des frais engagés par l'organisme de formation pour cette session:")
