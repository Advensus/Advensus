...
class Affichage(admin.ModelAdmin):
    list_display = ('username','first_name','email','phone_number','adress','date_joined','is_active','is_superuser','user_type','is_staff','updated_at','email_confirmed','organisme_formation', 'societe_formation','is_autorise')
    search_fields = ['username']

class AffichageCompany(admin.ModelAdmin):
...
admin.site.register(SocieteFormation)
