# Generated by Django 3.2.13 on 2022-05-04 09:22
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('intitule', models.CharField(max_length=20)),
                ('coordonner', models.ManyToManyField(related_name='admin_content_type', to=settings.AUTH_USER_MODEL)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.UUIDField(default=uuid.uuid4, editable=False, primary_key=True, serialize=False)),
                ('company', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='compte.company')),
            ],
        ),
        migrations.CreateModel(
            name='reservation',
        ...
        migrations.AddField(
            model_name='user',
            name='admin',
            field=models.ManyToManyField(related_name='admin_content_type', to='compte.formation'),
        ),
        migrations.AddField(
            model_name='user',
            name='appartenir',
